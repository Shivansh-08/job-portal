...
[])
    ...
    return (
    <div className='absolute top-0 left-0 bottom-0 right-0 z-10 background-blur-sm bg-black/30 flex justify-center items-center'>
      <form onSubmit={onSubmitHandler} className='relative bg-white p-10 rounded-xl text-slate-500'>
        ...
        <div className='flex items-center gap-4 my-10'>
            <label htmlFor="image">
                <img className="w-16 rounded-full cursor-pointer" src={image? URL.createObjectURL(image):assets.upload_area} alt="" srcset="" />
